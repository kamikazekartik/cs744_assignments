...
for epoch in range(args.start_epoch, args.epochs):
    if early_bird_30.early_bird_emerge(model):
        ...
        if flag_30:
            ...
            }, is_best, 'EB-30', filepath=args.save)
            epoch_30 = epoch + 1
            print('30 Mask first detected at epoch', epoch_30)
            flag_30 = False
    if early_bird_50.early_bird_emerge(model):
        ...
        if flag_50:
            ...
            'best_prec1': best_prec1,
            'optimizer': optimizer.state_dict(),
            }, is_best, 'EB-50', filepath=args.save)
            epoch_50 = epoch+1
            print('50 Mask first detected at epoch', epoch_50)
            flag_50 = False
    if early_bird_70.early_bird_emerge(model):
        ...
        if flag_70:
            ...
            'best_prec1': best_prec1,
            'optimizer': optimizer.state_dict(),
            }, is_best, 'EB-70', filepath=args.save)
            epoch_70 = epoch + 1
            print('70 mask first detected at epoch', epoch_70)
            flag_70 = False
...
print('Epoch 30:', epoch_30)
print('Epoch 50:', epoch_50)
print('Epoch 70:', epoch_70)
np.savetxt(os.path.join(args.save, 'record.txt'), history_score, fmt = '%10.5f', delimiter=',')
